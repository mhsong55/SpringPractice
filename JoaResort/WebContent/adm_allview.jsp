...
<head>
    ...
    <link href="css/adm_allview.css" type="text/css" rel="stylesheet" />
		    ...
		    <form action="login.do" class="log-in" autocomplete="off" method="POST"> 
		    	<h4>WECOME!</h4>
		      	...
		      	<div class="floating-label">
		        	<input placeholder="ID" type="text" name="id" id="idField" autocomplete="off">
			    ...
			    <div class="floating-label">
					<input placeholder="Password" type="password" name="pw" id="pwField" autocomplete="off">
